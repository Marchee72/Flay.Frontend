<template>
  <v-app light>
    ...
    <v-main dark>
      <section>
        <v-parallax src="../resources/img/main-picture.jpg" height="500">
          <v-layout column align-center justify-center class="white--text">
            ...
            <h1 class="white--text mb-2 display-1 text-center">Flay</h1>
            <div class="subheading mb-4 text-center">Tu consorcio online</div>
            <v-btn class="mt-12" color="blue lighten-2" dark large to="/login">
              Iniciar sesion
            </v-btn>
          </v-layout>
        </v-parallax>
      ...
      <section>
        <v-parallax src="../resources/img/main-picture2.jpg" height="380">
